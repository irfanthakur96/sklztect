    ...
    var Wcf_User_Guilder = {
        init: function (settings) {
            ...
            Wcf_User_Guilder.config = {
                ...
                has_update: false,
                welcome_heading: 'Welcome to Arolax 2.1.4',
                welcome_desc: 'Arolax is a versatile, responsive, and easily customizable digital agency portfolio WordPress theme. It comes with 40+ unique home pages, including the Dark and Light versions, along with a broad range of inner pages. Its specifically tailored for users who want to bring their websites to life with diverse, dynamic animations. The stunning look, exclusive features, and ultra-high performance make it a perfect choice for websites for digital agencies, startup businesses, design studios, digital marketing agencies, web design and development agencies, portfolio showcases, personal portfolios, and so on.',
                _required_plugins: [
                    {
                    ...
                    {
                        'slug': 'arolax-essential', 'title': 'Essential Plugin', 'remote-source': false
                    },
        ...
        goto_thankyou_page: function (path) {
            ...
            <div class="wcf--license-step-three">
                ${thanks}
                <a href="${path}" class="wcf--license-default-btn wcf--theme-demo-button wcf-demo-btn" style="${hidden}">Import demo</a>
            ...
            //if(!localStorage.getItem(path)){
                $('.wcf--theme-demo-button.wcf-demo-btn').attr('style','pointer-events: none; ');
                $('.wcf--theme-demo-button.wcf-demo-btn').text('activating');
                jQuery.ajax({
                    type: "post",
                    dataType: "json",
                    url: ajax_object.ajaxurl,
                    data: {
                        action: "wcf_activate_demo_extension",
                        nonce: ajax_object.ajax_nonce,
                    },
                    success: function (response) {
                        $('.wcf--theme-demo-button').show();
                        $('.wcf--theme-demo-button.wcf-demo-btn').attr('style','');
                        $('.wcf--theme-demo-button.wcf-demo-btn').text('Import demo');
