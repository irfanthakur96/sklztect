...
Class CustomFonts{
    ...
    public function push_dynamic_style() {  
       ...
       wp_add_inline_style( 'wcf--addons-pro', $custom_css );
    }
	...
	public function admin_scripts() {
		...
		if(isset($current_screen->id) && $current_screen->id == 'wcf-custom-fonts'){
			wp_enqueue_media();
			wp_enqueue_style( 'wcf-addon-pro-custom-fonts', WCF_ADDONS_PRO_URL . 'assets/build/modules/custom-font/main.css' );
			wp_enqueue_script( 'wcf-addon-pro-custom-fonts', WCF_ADDONS_PRO_URL . 'assets/build/modules/custom-font/main.js', array(
