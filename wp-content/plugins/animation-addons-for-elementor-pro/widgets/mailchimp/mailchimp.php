...
class Mailchimp extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Mailchimp', 'animation-addons-for-elementor-pro' );
	}
	...
	protected function register_form_content_controls() {
		...
		$this->add_control(
			'enable_name',
			[
				'label'        => esc_html__( 'Enable Name?', 'animation-addons-for-elementor-pro' ),
				'type'         => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'_fname_heading',
			[
				'label'     => esc_html__( 'First Name:', 'animation-addons-for-elementor-pro' ),
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'First Name', 'animation-addons-for-elementor-pro' ),
				'condition'   => [
					'enable_name'     => 'yes',
				],
				'dynamic'     => [ 'active' => true ],
		...
		$this->add_control(
			'_lname_heading',
			[
				'label'     => esc_html__( 'Last Name:', 'animation-addons-for-elementor-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'enable_name'     => 'yes',
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__( 'Label', 'animation-addons-for-elementor-pro' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Last Name', 'animation-addons-for-elementor-pro' ),
				'placeholder' => esc_html__( 'Last Name', 'animation-addons-for-elementor-pro' ),
				'condition'   => [
					'enable_name'     => 'yes',
				],
				'dynamic'     => [ 'active' => true ],
		...
		$this->add_control(
			'enable_phone',
			[
				'label'        => esc_html__( 'Enable Phone?', 'animation-addons-for-elementor-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'separator'    => 'before',
				'label_on'     => esc_html__( 'Yes', 'animation-addons-for-elementor-pro' ),
				'label_off'    => esc_html__( 'No', 'animation-addons-for-elementor-pro' ),
		...
		$this->add_control(
			'_phone_heading',
			[
				'label'     => esc_html__( 'Phone:', 'animation-addons-for-elementor-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'enable_phone' => 'yes',
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Phone', 'animation-addons-for-elementor-pro' ),
				'condition'   => [
					'enable_phone' => 'yes',
				],
				'dynamic'     => [ 'active' => true ],
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'before',
				'options'   => [
					'before' => __( 'Before', 'animation-addons-for-elementor-pro' ),
					'after'  => __( 'After', 'animation-addons-for-elementor-pro' ),
				],
				'condition' => [ 'enable_phone' => 'yes' ],
			]
		);
	...
	protected function register_input_icon_style_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Input Icon', 'animation-addons-for-elementor-pro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
